...
class CR_Razorpay {
    ...
    public function create_order() {
        ...
        $amount_paise = intval($total_amount * 100); // convert to paise
        ...
        $orderData = [
            ...
            'payment_capture' => 1,
            'notes' => [
                'Base Price (₹)'     => number_format($base_amount, 2),
                'GST 18% (₹)'        => number_format($gst_amount, 2),
                'Total Payable (₹)'  => number_format($total_amount, 2),
                'Plan'               => 'Online Library Membership (Annual)',
